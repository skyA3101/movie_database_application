...
class MovieDetail {
  ...
  final int? runtime; // only for movies
  final int? numberOfSeasons; // only for series
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'genres': jsonEncode(genres), // encode as JSON string
      'genre_ids': jsonEncode(genreIds) // encode as JSON string
    };
  }
}
